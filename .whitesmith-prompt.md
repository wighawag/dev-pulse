# Task: Implement "Add auto-work detection via config, label, and issue body"
...
**Task ID:** 23-001
**Task File:** tasks/23/001-add-auto-work-detection.md
...
5. **Delete the task file** at `tasks/23/001-add-auto-work-detection.md` — this marks the task as complete.
...
```
git add -A
git commit -m "feat(#23): Add auto-work detection via config, label, and issue body"
```
...
- You MUST delete `tasks/23/001-add-auto-work-detection.md` as part of your commit.
